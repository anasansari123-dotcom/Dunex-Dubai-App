  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.pageTitle}>Pay by Credit Card</Text>
            ...
            {paymentOptions.map((item, index) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  item.name === "Credit Card" && styles.activePaymentMethod
                ]}
              ...
              >
                <Ionicons 
                  ...
                  size={24} 
                  color={item.name === "Credit Card" ? "#071538" : "#D4AF37"} 
                />
                <Text style={[
                  styles.paymentMethodText,
                  item.name === "Credit Card" && styles.activePaymentMethodText
                ]}>
                  {item.name}
                </Text>
              </TouchableOpacity>
